                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="clearfix info-list">
                                        <li><i class="fas fa-map-marker-alt"></i>No.123, 5th Channel, Anuradhapura</li>
                                        <li><i class="fas fa-microphone"></i><a href="tel:23055873407">+94-763-241-451</a></li>
                                        <li><i class="fas fa-envelope"></i><a href="mailto:info@example.com">info@nexsign.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="auto-container">
                    <div class="clearfix inner-box">
                        ...
                        <div class="copyright pull-left">
                            <p><a href="index.html">nexSign Global</a> © 2024 All Right Reserved</p>
                        </div>
